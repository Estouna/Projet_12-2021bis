...
<main class="main">
    ...
    <section class="section-center column centerAll">
        ...
        <p class="p-subTitle margB-s">Le site où vous trouverez tout ce qu'il vous faut pour apprendre à coder.</p>
        <div id="demo_box1" class="demo-box">
            ...
            <div class="overlay-content display1 column centerAll">
                <ul class="ul-home column centerAll gap-l">
                    ...
                    <li><a class="a-home" href="../tutoForum/EAA-balises-html.php">Les balises HTML</a></li>
        ...
        <div id="demo_box2" class="demo-box">
            ...
            <div class="overlay-content display2 column centerAll">
                <ul class="ul-home column centerAll gap-l">
                    ...
                    <li><a class="a-home" href="../tutoForum/EBA-propri-css.php">Les propriétés de CSS</a></li>
        ...
        <div id="demo_box3" class="demo-box">
            ...
            <div class="overlay-content display3 column centerAll">
                <ul class="ul-home column centerAll gap-l">
                    ...
                    <li><a class="a-home" href="../tutoForum/ECA-ref-javascript.php">Référence de JavaScript</a></li>
