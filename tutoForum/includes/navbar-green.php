        ...
        <nav id="navConnect">
            ...
            <div>
                ...
                <ul class="slide slide-green column centerAll">
                    ...
                    <li><a class="a-navMenu-green" href="../../tutoForum/actions/users/logoutAction.php">Déconnexion</a></li>
                </ul>
            </div>
...
?>
    ...
    <header id="header" class="header-green row centerAlign">
        ...
        <nav id="navMenu">
            <ul class="navMenu-ul navMenu-ul-green row centerJust centerAlign">
                <li class="navMenu-li"><a class="a-navMenu a-navMenu-green" href="../../tutoForum/index.php">ACCUEIL</a></li>
                <li class="li-dropdown a-navMenu-green column centerAll unselectable">TUTO
                    <ul class="panel panel-green column centerAll">
                        <li class="navMenu-li"><a class=" a-html a-navMenu-green" href="../../tutoForum/EA-tuto-html.php">HTML</a></li>
        ...
        <nav id="navConnect">
            <a class="link-profil a-navMenu-green" href="../../tutoForum/AAB-login.php">Se connecter</a>
            <div>
                <label for="touch">
                    <span class="spanNav row centerAlign">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-dash iconPersoDeco iconPersoDeco-green" viewBox="0 0 16 16">
                            <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10z" />
                ...
                <ul class="slide2 slide2-green column centerJust centerAlign">
                    <li><a class="a-navMenu-green" href="../../tutoForum/AAB-login.php">Connexion</a></li>
                </ul>
            </div>
        </nav>
    </header>
