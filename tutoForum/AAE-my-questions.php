            ...
            <div class="shadow-green post-margin">
                <div class="block-subject show-content neumorph-subject column centerJust">
                    ...
                    <div class="modif-subject row centerAlign centerJust">
                        ...
                        <a class="btn-effacer row centerJust centerAlign" onclick='return confirm(" Cette action est irréversible, êtes-vous sûr ? ")' href="../tutoForum/actions/topic/deleteQuestionAction.php?id=<?= $question['id'] ?>">EFFACER</a>
                    </div>
                </div>
            </div>
